...
export default function RegisterPage() {
  ...
  const [form, setForm] = useState({
    ...
    phone: "",
    password: "",
    segment: "household" as CustomerSegment,
  });
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex flex-col items-center gap-3">
            ...
            <div className="text-left">
              ...
              <div className="text-water-200 text-xs font-medium uppercase tracking-widest">
                Limited
              </div>
            </div>
          </Link>
        ...
        <div className="bg-white rounded-3xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="btn-primary w-full flex items-center justify-center gap-2 py-4 disabled:opacity-60 mt-2"
            >
              {loading ? (
                <>
